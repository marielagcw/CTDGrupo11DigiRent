        ...
        <div className="container-fluid">
          <div className="logo-frase d-flex align-items-center">
            <div className="logo" onClick={() => navigate("/")}>
              ...
              <p className="logo-text ps-2 fw-bold mb-0">
                Digi{" "}
                <span className="bg-tertiary fw-bold text-light ps-1 pe-1">
                  Rent
                </span>
              </p>
            </div>
          ...
          {userSession ? (
            widthWindow > 600 ? (
              <UserInfo userInfo={JSON.parse(userSession)} />
            ) : (
              " "
            )
          ) : (
            ...
            >
              {btn !== "login" && (
                <Link to="/register">
                  <button
                    className="btn btn-lg btn-border-primary"
                    id="createAcount"
                  >
                    Crear cuenta
                  </button>
              ...
              {btn !== "register" && (
                <Link to="/login">
                  <button
                    className="btn btn-lg btn-border-primary ms-2 me-2"
                    id="logIn"
                  >
                    Iniciar sesión
                  </button>
          ...
          {widthWindow <= 600 && (
            <Menu right width={"60%"} styles={{ height: "20%" }}>
              {userSession ? (
                <>
                  <div
                    className="menu-home-burguer"
                    style={{
                      height: "175px",
                      display: "flex",
                      alignItems: "end",
                ...
                <>
                  ...
                  <div
                    style={{ height: "67%", idth: "100%", padding: "0px 15px" }}
                  >
                    {location.pathname !== "/login" && (
                      <a
                        id="about"
                        className="menu-item a-iniciar-crear"
                        style={{
                          display: "block",
                          textAlign: "end",
                          padding: "17px 0px",
