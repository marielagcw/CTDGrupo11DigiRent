    ...
    <>
      ...
      <div className="flex" id="logInForm">
        <div className="form-container">
          ...
          <form
            onSubmit={(e) => {
              setTimeout(setLogged, 500, { logged: handleSubmit(e) });
              Swal.fire("Gracias por regresar!", "", "sucess", {
          ...
          >
            {errors.badCredentials && (
              <p className="error">{errors.badCredentials}</p>
            )}
          ...
          <div className="mt-5">
            <p>
              ...
              <span id="link" onClick={() => navigate("/register")}>
                Registrate
              </span>
            </p>
          </div>
